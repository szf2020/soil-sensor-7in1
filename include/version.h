...
// Generated by scripts/auto_version.py at 2025-07-27T06:30:05.272204+00:00Z

#define JXCT_VERSION_MAJOR 3
#define JXCT_VERSION_MINOR 10
#define JXCT_VERSION_PATCH 1

#define STRINGIFY(x) #x
#define TOSTRING(x) STRINGIFY(x)
#define JXCT_VERSION_STRING \
    TOSTRING(JXCT_VERSION_MAJOR) "." TOSTRING(JXCT_VERSION_MINOR) "." TOSTRING(JXCT_VERSION_PATCH)
