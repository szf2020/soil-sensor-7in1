...
constexpr unsigned long WEB_UPDATE_INTERVAL = 10000; // 10 сек - стабильная работа веб-интерфейса
...
constexpr unsigned char FORCE_PUBLISH_CYCLES =
    5;  // Принудительная публикация каждые 5 циклов (5 мин при 1 мин интервале)
...
struct __attribute__((packed)) Config
{
    ...
    // v3.13.0: СИСТЕМА КАЛИБРОВКИ (28 байт)
